...
CREATE TABLE platform_rate_history (
    id BIGSERIAL PRIMARY KEY,
    platform_id BIGINT NOT NULL,
...
CREATE INDEX idx_balance_account_id ON account_balance_history(account_id);
CREATE INDEX idx_balance_platform_id ON account_balance_history(platform_id);
CREATE INDEX idx_rate_platform_id ON platform_rate_history(platform_id);
CREATE INDEX idx_rate_channel_name ON platform_rate_history(channel_name);
CREATE INDEX idx_task_schedule_enabled ON task_schedule(is_enabled);
CREATE INDEX idx_task_schedule_group ON task_schedule(task_group);
CREATE INDEX idx_task_log_task_key ON task_execution_log(task_key);
CREATE INDEX idx_task_log_create_time ON task_execution_log(create_time DESC);
